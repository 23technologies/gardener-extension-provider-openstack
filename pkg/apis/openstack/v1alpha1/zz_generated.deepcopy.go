...
func (in *CloudProfileConfig) DeepCopyInto(out *CloudProfileConfig) {
	*out = *in
	...
	if in.DNSServersPerRegion != nil {
		in, out := &in.DNSServersPerRegion, &out.DNSServersPerRegion
		*out = make([]DNSServersPerRegion, len(*in))
		for i := range *in {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DNSServersPerRegion) DeepCopyInto(out *DNSServersPerRegion) {
	*out = *in
	if in.DNSServers != nil {
		in, out := &in.DNSServers, &out.DNSServers
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DNSServersPerRegion.
func (in *DNSServersPerRegion) DeepCopy() *DNSServersPerRegion {
	if in == nil {
		return nil
	}
	out := new(DNSServersPerRegion)
	in.DeepCopyInto(out)
	return out
}
