...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*DNSServersPerRegion)(nil), (*openstack.DNSServersPerRegion)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_DNSServersPerRegion_To_openstack_DNSServersPerRegion(a.(*DNSServersPerRegion), b.(*openstack.DNSServersPerRegion), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*openstack.DNSServersPerRegion)(nil), (*DNSServersPerRegion)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_openstack_DNSServersPerRegion_To_v1alpha1_DNSServersPerRegion(a.(*openstack.DNSServersPerRegion), b.(*DNSServersPerRegion), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*InfrastructureState)(nil), (*openstack.InfrastructureState)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_InfrastructureState_To_openstack_InfrastructureState(a.(*InfrastructureState), b.(*openstack.InfrastructureState), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*openstack.InfrastructureState)(nil), (*InfrastructureState)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_openstack_InfrastructureState_To_v1alpha1_InfrastructureState(a.(*openstack.InfrastructureState), b.(*InfrastructureState), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CloudProfileConfig_To_openstack_CloudProfileConfig(in *CloudProfileConfig, out *openstack.CloudProfileConfig, s conversion.Scope) error {
	...
	out.DNSServersPerRegion = *(*[]openstack.DNSServersPerRegion)(unsafe.Pointer(&in.DNSServersPerRegion))
...
func autoConvert_openstack_CloudProfileConfig_To_v1alpha1_CloudProfileConfig(in *openstack.CloudProfileConfig, out *CloudProfileConfig, s conversion.Scope) error {
	...
	out.DNSServers = *(*[]string)(unsafe.Pointer(&in.DNSServers))
	out.DNSServersPerRegion = *(*[]DNSServersPerRegion)(unsafe.Pointer(&in.DNSServersPerRegion))
	out.DHCPDomain = (*string)(unsafe.Pointer(in.DHCPDomain))
	out.KeyStoneURL = in.KeyStoneURL
	out.KeyStoneCACert = (*string)(unsafe.Pointer(in.KeyStoneCACert))
	out.KeyStoneForceInsecure = in.KeyStoneForceInsecure
...
func autoConvert_v1alpha1_DNSServersPerRegion_To_openstack_DNSServersPerRegion(in *DNSServersPerRegion, out *openstack.DNSServersPerRegion, s conversion.Scope) error {
	out.Region = in.Region
	out.DNSServers = *(*[]string)(unsafe.Pointer(&in.DNSServers))
	return nil
}

// Convert_v1alpha1_DNSServersPerRegion_To_openstack_DNSServersPerRegion is an autogenerated conversion function.
func Convert_v1alpha1_DNSServersPerRegion_To_openstack_DNSServersPerRegion(in *DNSServersPerRegion, out *openstack.DNSServersPerRegion, s conversion.Scope) error {
	return autoConvert_v1alpha1_DNSServersPerRegion_To_openstack_DNSServersPerRegion(in, out, s)
}

func autoConvert_openstack_DNSServersPerRegion_To_v1alpha1_DNSServersPerRegion(in *openstack.DNSServersPerRegion, out *DNSServersPerRegion, s conversion.Scope) error {
	out.Region = in.Region
	out.DNSServers = *(*[]string)(unsafe.Pointer(&in.DNSServers))
	return nil
}

// Convert_openstack_DNSServersPerRegion_To_v1alpha1_DNSServersPerRegion is an autogenerated conversion function.
func Convert_openstack_DNSServersPerRegion_To_v1alpha1_DNSServersPerRegion(in *openstack.DNSServersPerRegion, out *DNSServersPerRegion, s conversion.Scope) error {
	return autoConvert_openstack_DNSServersPerRegion_To_v1alpha1_DNSServersPerRegion(in, out, s)
}
...
func autoConvert_v1alpha1_InfrastructureState_To_openstack_InfrastructureState(in *InfrastructureState, out *openstack.InfrastructureState, s conversion.Scope) error {
	out.Data = *(*map[string]string)(unsafe.Pointer(&in.Data))
	return nil
}

// Convert_v1alpha1_InfrastructureState_To_openstack_InfrastructureState is an autogenerated conversion function.
func Convert_v1alpha1_InfrastructureState_To_openstack_InfrastructureState(in *InfrastructureState, out *openstack.InfrastructureState, s conversion.Scope) error {
	return autoConvert_v1alpha1_InfrastructureState_To_openstack_InfrastructureState(in, out, s)
}

func autoConvert_openstack_InfrastructureState_To_v1alpha1_InfrastructureState(in *openstack.InfrastructureState, out *InfrastructureState, s conversion.Scope) error {
	out.Data = *(*map[string]string)(unsafe.Pointer(&in.Data))
	return nil
}

// Convert_openstack_InfrastructureState_To_v1alpha1_InfrastructureState is an autogenerated conversion function.
func Convert_openstack_InfrastructureState_To_v1alpha1_InfrastructureState(in *openstack.InfrastructureState, out *InfrastructureState, s conversion.Scope) error {
	return autoConvert_openstack_InfrastructureState_To_v1alpha1_InfrastructureState(in, out, s)
}
...
func autoConvert_v1alpha1_RouterStatus_To_openstack_RouterStatus(in *RouterStatus, out *openstack.RouterStatus, s conversion.Scope) error {
	out.ID = in.ID
	out.IP = in.IP
	out.ExternalFixedIPs = *(*[]string)(unsafe.Pointer(&in.ExternalFixedIPs))
	return nil
}
